package com.github.sanoyuji1007.SAOMod.entity.model;
...
public class BlackSlimeModel<T extends Entity> extends EntityModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION =
			new ModelLayerLocation(
					ResourceLocation.fromNamespaceAndPath(SaoMod.MOD_ID, "black_slime_layer"),
					"main"
			);
	private final ModelPart root;

	public BlackSlimeModel(ModelPart root) {
